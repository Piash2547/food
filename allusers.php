...
<head>
    ...
    <!-- Favicon icon -->
	<link rel="icon" type="image/png" sizes="16x16" href="images/foodfrancy.png">
    <title>Food Francy - Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.php">
                        <!-- Logo icon -->
                        <b><img src="images/foodfrancy.png" alt="homepage" class="dark-logo" width = "25px"/></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><b>Food Francy </b></span>
                    </a>
                </div>
                <!-- End Logo -->
        ...
        <div class="page-wrapper">
            ...
            <!-- footer -->
            <footer class="footer"> © 2022 All rights reserved. Made by <b>Food Francy </a></b> Team. </footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
